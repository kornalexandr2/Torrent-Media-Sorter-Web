...
class Scanner:
    def __init__(self):
        self.stop_words = self._load_simple_list(BASE_DIR.parent / 'stop_words.txt')
        self.series_masks = self._load_masks(BASE_DIR.parent / 'masks_series.txt')
        self.movies_masks = self._load_masks(BASE_DIR.parent / 'masks_movies.txt')
